...
cod_estado*/
  ...
  public $ind_confir_jefe;
  function POST_ind_confir_jefe(){
    return $this->ind_confir_jefe;
  }
  function set_ind_confir_jefe($ind_confir_jefe){
    $this->ind_confir_jefe = $ind_confir_jefe;
  }
}
