<?php
	...
	//
	$lt_TipTramites = $objTramites->getTiposTramiteExpedientes();
?>
...
function buscarTramites(){
  ...
  $.get("inc_tramite_registrar_are_val.php?fecha1="+fecha1+"&fecha2="+fecha2+"&ad="+administrado+"&cbo="+cbo, function(data, status){
...
function NuevoTramite(){
	document.location.href = "Registrar_Tramite_Area_Valores2.php";
}
</script>
