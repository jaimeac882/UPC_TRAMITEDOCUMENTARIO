		...
		<div class="col-sm-9 col-md-9">
          ...
          <div class="form-group row">
            <div class="col-xs-6">
              ...
              <input type="text" disabled="true" class="form-control input-sm" id="ejemplo_email_1" />
            </div>
            <div class="col-xs-6">
              <label for="formGroupExampleInput2">Fecha</label>
              <input id="fechaentrega" disabled="true" name="fechaentrega" placeholder="fecha entrega" class="form-control input-sm"
                required="">
            </div>
          </div>
