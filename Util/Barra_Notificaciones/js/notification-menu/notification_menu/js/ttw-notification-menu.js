...
(function($) {
     ...
     $.ttwNotificationMenu = function(userOptions) {
        ...
        defaults = {
            ...
            anchor:'body',
            relativeImagePath:'js/notification-menu/notification_menu/images/',
        ...
        //inicio: gerardo
        function eraseInitUnreadContador(category)
        {
            notifications[category].unreadCount = 0;
        }
        //fin: gerardo
        ...
        function unregisterNotification(notification) {
            ...
            //notifications[notification.category].unreadCount-- ;//propuesto habilitado Gerardo
        ...
        function getNotifications(category, readStatus) {
            ...
            notifications[category].unreadCount=0; //Agregado por Gerardo Medina
            notifications[category].readCount=0; //Agregado por Gerardo Medina            
        ...
        MenuItem = function(category, selector) {
            ...
            //this.contadorPrevio= op;//Gerardo
        };
        ...
        MenuItem.prototype.resetCountBubble = function() {
            
            var count=0;
            notifications[this.category].unreadCount = 0;
            count=notifications[this.category].unreadCount;
            this.$bubble.html(count);
        ...
        NotificationList = function(notificationListOptions) {
            ...
            this.markup = {
                ...
                notificationList:'<ul id="lista_notificaciones" class="notification-list"></ul>',
        ...
        //ProtoGerardo: INICIO
        notificationMenu.setContadorPrevio = function(category) {
             eraseInitUnreadContador(category);
        };
        //ProtoGerardo: FIN
        ...
        notificationMenu.deleteNotification = function(notification){
             ...
             notification.destroy();// es original, pero suprimido por Gerardo
            //notificationMenu.notifications[notification.category].count--;//gerardo
        };
